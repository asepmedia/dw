    ...
    <div class="bg-slate-50 dark:bg-slate-900 min-h-screen w-screen">
        <div class="container px-5 py-5 md:px-10 md:py-10 mx-auto">
            <div class="flex flex-col gap-y-5">
                ...
                <div class="bg-slate-500 dark:bg-slate-900/75 border rounded-xl py-3 px-6 md:sticky top-0 backdrop-blur z-[9999]">
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/5 mb-3 md:mb-2 mx:px-2">
                            <div class="px-1">
                                <label class="text-slate-50 font-bold">Periode</label>
                                <multiselect
                        ...
                        <div class="w-full md:w-1/5 mb-3 md:mb-2 mx:px-2">
                            <div class="px-1">
                                <label class="text-slate-50 font-bold">Barang</label>
                                <multiselect
                                    v-model="model.item"
                        ...
                        <div class="w-full md:w-1/5 mb-3 md:mb-2 mx:px-2">
                            <div class="px-1">
                                <label class="text-slate-50 font-bold">Pelanggan</label>
                                <multiselect
